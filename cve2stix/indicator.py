...
def parse_cve_indicator(cve:dict, vulnerability: Vulnerability) -> 'tuple[Indicator, Relationship]|None':
    if not cve.get("configurations"):
        return None
    cpe_names, pattern_so_far, cpeIds = build_patterns_for_cve(cve["id"], cve.get("configurations", []))
