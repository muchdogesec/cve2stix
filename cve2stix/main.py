...
def map_extensions(config, object_list):
    ...
    extensions = [stix_extensions.indicator_vulnerable_cpes_ExtensionDefinitionSMO, stix_extensions.vulnerability_scoring_ExtensionDefinitionSMO, stix_extensions.report_epss_scoring_ExtensionDefinitionSMO]
